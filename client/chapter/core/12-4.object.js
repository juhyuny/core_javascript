...
// console.log( shopOrder.menu[0].price + shopOrder.menu[1].price);    // 통 새우 돈까스, 치즈 돈까스
// console.log( shopOrder.menu[0].price * shopOrder.menu[0].count + shopOrder.menu[1].price * shopOrder.menu[1].count );    // 통 새우 돈까스 2개, 치즈 돈까스
